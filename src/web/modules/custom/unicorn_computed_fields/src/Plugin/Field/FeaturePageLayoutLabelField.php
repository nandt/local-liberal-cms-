...
/**
 * Resolves a Feature page-layout machine ID to its dashboard-facing label.
 *
 * @extends FieldItemList<\Drupal\Core\Field\FieldItemInterface>
 */
final class FeaturePageLayoutLabelField extends FieldItemList {
  ...
  protected function computeValue(): void {
    ...
    if (isset($labels[$layout])) {
      $this->list[0] = $this->createItem(0, ['value' => $labels[$layout]]);
    }
  }
