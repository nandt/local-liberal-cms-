...
$settings['s3fs.use_s3_for_public'] = getenv("S3_USE_FOR_PUBLIC_FOLDER");
if ($s3_cname = getenv("S3_CNAME")) {
  $config['s3fs.settings']['use_cname'] = TRUE;
  $config['s3fs.settings']['domain'] = $s3_cname;
}
$config['metatag.metatag_defaults.node']['tags']['robots'] = getenv("METATAG_ROBOTS")
