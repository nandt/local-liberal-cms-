        ...
        if ($this->runInSeparateProcess()) {
            ...
            if ($runEntireClass) {
                $template = new Text_Template(
                    'E:\docker-projects\liberal\src\vendor\composer/../phpunit/phpunit/src/Util/PHP/Template/TestCaseClass.tpl'
                );
            } else {
                $template = new Text_Template(
                    'E:\docker-projects\liberal\src\vendor\composer/../phpunit/phpunit/src/Util/PHP/Template/TestCaseMethod.tpl'
                );
            }
